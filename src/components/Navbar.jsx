            ...
            <div className="flex justify-between">
              <ul className="flex space-x-8 px-4 py-2">
                <li>
                  <Link
                    href="/movies"
                    className="text-sm font-medium text-gray-700 hover:text-[#f84464] transition-colors"
                  >
                    Movies
                  </Link>
                </li>
          ...
          {isMobileMenuOpen && (
            <div className="md:hidden bg-white border-t border-gray-200">
              ...
              <div className="px-4 py-3 border-t border-gray-200">
                <button 
                  className="w-full bg-[#f84464] hover:bg-[#e23b5b] text-white font-medium py-2 px-4 rounded-md transition-colors"
                  onClick={() => setIsSignInOpen(true)}
                >
                  Sign in
                </button>
